  ...
  return (
    <div className="navbar">
      ...
      <ul className="navbar-menu">
        ...
        <li onClick={()=>setMenu("mobile-app")} className={menu==="mobile-app"?"active":""}>Aplicación</li>
        <li onClick={()=>setMenu("contact-us")} className={menu==="contact-us"?"active":""}>Contáctanos</li>
      </ul>
